...
export default function ControlButtons({
  ...
  return (
    <div className="w-full backdrop-blur-xl border border-slate-800 bg-slate-900/90 shadow-slate-950/50 rounded-3xl p-6 shadow-xl flex flex-col items-center justify-center space-y-5 transition-colors duration-300">
      ...
      <div className="w-full max-w-md flex items-center justify-between pt-2 border-t border-slate-800/80 text-xs transition-colors duration-300">
        ...
        {isRepeatVisible ? (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl transition-colors cursor-pointer bg-slate-800/80 hover:bg-slate-800 text-slate-400 hover:text-slate-200"
          >
        ...
        {isEmergencyStopVisible && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border transition-colors cursor-pointer ml-auto bg-slate-800/50 hover:bg-rose-950/40 text-slate-500 hover:text-rose-300 border-slate-800"
