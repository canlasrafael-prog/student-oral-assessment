...
export default function TestPage() {
  ...
  useEffect(() => {
    if (isMounted && !studentInfo) {
      router.replace('/register');
    }
  }, [isMounted, studentInfo, router]);
  ...
  if (!isMounted || !studentInfo || questions.length === 0) {
    return <div className="min-h-screen bg-slate-950" suppressHydrationWarning />;
  }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between p-4 sm:p-6 lg:p-8" suppressHydrationWarning>
