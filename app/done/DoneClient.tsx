      ...
      <div className="relative w-full max-w-3xl backdrop-blur-xl border border-slate-800 bg-slate-900/90 shadow-slate-950/50 rounded-3xl p-6 sm:p-10 shadow-2xl space-y-8 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <button
            ...
            className="py-3.5 px-4 rounded-2xl font-bold bg-blue-600 hover:bg-blue-500 text-white border border-blue-400/30 active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-blue-600/30 group cursor-pointer text-xs"
          >
            <svg className="w-4 h-4 text-white group-hover:translate-y-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
